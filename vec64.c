...
"each byte contains the RFC 4648 integer value of the corresponding\n"
"symbol from the input sequence.  Processing stops at the first non-\n"
"Base64 symbol or when the end of the input is reached, whichever is\n"
"soonest.  Padding characters (`'='`) terminate processing as though\n"
"they were non-Base64 symbols, however up to two will be transformed\n"
"into `chr(64)` (`b'@'`) at the end of the input.\n"
"\n"
"Usage examples:\n"
"\n"
"```python\n"
